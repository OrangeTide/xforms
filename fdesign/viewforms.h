...
extern void text_timeout_cb( FL_OBJECT *,
							 long );
extern void file_mnu_cb( FL_OBJECT *,
						 long );
extern void options_mnu_cb( FL_OBJECT *,
							long );
extern void but_cb( FL_OBJECT *,
					long );
extern void help_mnu_cb( FL_OBJECT *,
						 long );
extern void movie_slider_cb( FL_OBJECT *,
							 long );

extern void help_nav_cb( FL_OBJECT *,
						 long );
extern void text_timeout_cb( FL_OBJECT *,
							 long );
extern void but_cb( FL_OBJECT *,
...
extern void but_cb( FL_OBJECT *,
					long );
extern void font_choice_cb( FL_OBJECT *,
							long );
extern void size_choice_cb( FL_OBJECT *,
							long );

extern void but_cb( FL_OBJECT *,
				    long );

extern void update_cb( FL_OBJECT *,
					   long );
extern void but_cb( FL_OBJECT *,
					long );
extern void label_dist_cb( FL_OBJECT *,
						   long );
extern void freq_dist_cb( FL_OBJECT *,
						  long );
extern void anim_time_cb( FL_OBJECT *,
						  long );

extern void x_snap_cb( FL_OBJECT *,
					   long );
extern void y_snap_cb( FL_OBJECT *,
					   long );
extern void r_snap_cb( FL_OBJECT *,
					   long );
extern void z_snap_cb( FL_OBJECT *,
					   long );
extern void but_cb( FL_OBJECT *,
					long );
...
extern void but_cb( FL_OBJECT *,
					long );
extern void x_size_cb( FL_OBJECT *,
					   long );
extern void y_size_cb( FL_OBJECT *,
					   long );

extern void but_cb( FL_OBJECT *,
					long );
extern void Void( FL_OBJECT *,
				  long );
...
extern void but_cb( FL_OBJECT *,
					long );
extern void interp_freq_cb( FL_OBJECT *,
							long );
