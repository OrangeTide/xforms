/* Form definition file generated by fdesign on Sat Nov 23 20:19:06 2013 */
...
create_form_attrib( void )
{
    ...
    fdui->readyobj = obj = fl_add_button( FL_RETURN_BUTTON, 550, 200, 70, 25, "Accept" );

    fdui->cancelobj = obj = fl_add_button( FL_NORMAL_BUTTON, 550, 240, 70, 25, "Cancel" );
    fl_set_button_shortcut( obj, "#C^[", 1 );

    fdui->restoreobj = obj = fl_add_button( FL_NORMAL_BUTTON, 550, 280, 70, 25, "   Restore   " );
