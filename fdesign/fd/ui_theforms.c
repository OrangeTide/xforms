...
FD_control *create_form_control(void)
{
	...
	fdui->title = obj = fl_add_text(FL_NORMAL_TEXT,452,0,125,22,
									"Form Designer");
	...
	fdui->formbrowser = obj = fl_add_browser(FL_HOLD_BROWSER,20,89,140,68,
											 "Forms");
    fl_set_object_lalign(obj,FL_ALIGN_TOP);
    fl_set_object_callback(obj,form_cb,0);

	fdui->groupbrowser = obj = fl_add_browser(FL_HOLD_BROWSER,20,174,140,70,
											  "Groups");
    fl_set_object_lalign(obj,FL_ALIGN_TOP);
	...
	obj = fl_add_text(FL_NORMAL_TEXT,440,17,138,13,
					  "(c) T.C. Zhao & Mark Overmars");
    fl_set_object_boxtype(obj,FL_NO_BOX);
    fl_set_object_lsize(obj,FL_TINY_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);

	fdui->objectbrowser = obj = fl_add_browser(FL_HOLD_BROWSER,170,89,135,155,
											   "Objects");
    fl_set_object_lalign(obj,FL_ALIGN_TOP);
	...
	fdui->renameform = obj = fl_add_button(FL_NORMAL_BUTTON,148,36,78,25,
										   "Rename Form");
    fl_set_object_color(obj,FL_COL1,FL_RED);
	...
	fdui->optionmenu = obj = fl_add_menu(FL_PULLDOWN_MENU,365,4,60,20,
										 "Options");
...
FD_align *create_form_align(void)
{
	...
	fdui->dismiss = obj = fl_add_button(FL_NORMAL_BUTTON,195,95,70,25,
										"Dismiss");
...
FD_test *create_form_test(void)
{
	...
	fdui->browser = obj = fl_add_browser(FL_NORMAL_BROWSER,6,22,259,224,
										 "Object Returned");
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_TOP);
	...
	fdui->stoptesting = obj = fl_add_button(FL_NORMAL_BUTTON,134,254,80,26,
											"Stop Testing");
