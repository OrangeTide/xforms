/* Form definition file generated by fdesign on Fri Nov  8 19:02:08 2013 */
...
create_form_buttonattrib( void )
{
    ...
    fdui->use_data = obj = fl_add_checkbutton( FL_PUSH_BUTTON, 180, 210, 30, 30, "Use Data" );
    fl_set_object_lalign( obj, FL_ALIGN_LEFT );
    fl_set_object_callback( obj, usedata_change, 0 );

    fdui->fullpath = obj = fl_add_checkbutton( FL_PUSH_BUTTON, 280, 210, 30, 30, "Full Path" );
    fl_set_object_lalign( obj, FL_ALIGN_LEFT );
