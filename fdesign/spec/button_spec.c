...
create_form_buttonattrib( void )
{
    ...
    fdui->filename = obj = fl_add_input( FL_NORMAL_INPUT, 160, 110, 210, 25, "Icon File" );
    fl_set_object_callback( obj, iconbutton_filename_change, 0 );
    fl_set_object_return( obj, FL_RETURN_END_CHANGED );

    fdui->pixalign = obj = fl_add_choice( FL_NORMAL_CHOICE2, 280, 70, 155, 25, "" );
    fl_set_object_callback( obj, pixalign_change, 0 );

    fdui->showfocus = obj = fl_add_checkbutton( FL_PUSH_BUTTON, 160, 80, 30, 30, "Show Focus" );
    fl_set_object_lalign( obj, FL_ALIGN_LEFT );
    fl_set_object_callback( obj, showfocus_change, 0 );
    fl_set_button( obj, 1 );

    fdui->browse = obj = fl_add_button( FL_NORMAL_BUTTON, 370, 110, 66, 25, "Browse ...." );
