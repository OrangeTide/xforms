/* Form definition file generated by fdesign on Tue Nov 19 15:01:00 2013 */
...
create_form_buttonattrib( void )
{
    ...
    fdui->use_data = obj = fl_add_checkbutton( FL_PUSH_BUTTON, 180, 210, 30, 30, "'#include' file" );
    fl_set_object_lalign( obj, FL_ALIGN_LEFT );
    fl_set_object_callback( obj, usedata_change, 0 );

    fdui->fullpath = obj = fl_add_checkbutton( FL_PUSH_BUTTON, 310, 210, 30, 30, "Use full path" );
    fl_set_object_lalign( obj, FL_ALIGN_LEFT );
