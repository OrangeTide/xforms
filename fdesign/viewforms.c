...
{
	FL_OBJECT *obj;
	FD_help *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_fontselect *
create_form_fontselect( void )
{
	FL_OBJECT *obj;
	FD_fontselect *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_about *
create_form_about( void )
{
	FL_OBJECT *obj;
	FD_about *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_brucc_opt *
create_form_brucc_opt( void )
{
	FL_OBJECT *obj;
	FD_brucc_opt *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_snapshot *
create_form_snapshot( void )
{
	FL_OBJECT *obj;
	FD_snapshot *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_log *
create_form_log( void )
{
	FL_OBJECT *obj;
	FD_log *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_save *
create_form_save( void )
{
	FL_OBJECT *obj;
	FD_save *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_save_as_file *
create_form_save_as_file( void )
{
	FL_OBJECT *obj;
	FD_save_as_file *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_save_as *
create_form_save_as( void )
{
	FL_OBJECT *obj;
	FD_save_as *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_color_opt *
create_form_color_opt( void )
{
	FL_OBJECT *obj;
	FD_color_opt *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
...
FD_interp *
create_form_interp( void )
{
	FL_OBJECT *obj;
	FD_interp *fdui = fl_calloc(1, sizeof *fdui );
	int old_bw = fl_get_border_width();
